...
//        linked.remove(20);
        linked.display();
//        LinkAndSequence.Linked.Node cur =linked.reverseList();
//        linked.show(cur);
//        LinkAndSequence.Linked.Node cur = linked.middleNode();
//        System.out.println(cur.getData());
//        LinkAndSequence.Linked.Node cur = linked.FindKthToTail(1);
//        System.out.println(cur.getData());
